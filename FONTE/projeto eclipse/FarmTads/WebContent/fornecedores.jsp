<%@page contentType="text/html"
        pageEncoding="UTF-8"
        language="java"
        import="com.farmacia.controle.CtrlFornecedor,com.farmacia.model.Fornecedor,java.util.Vector" %>
<html>
...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="66%" id="AutoNumber1" bgcolor="#666633" height="483">
  ...
  <tr>
    ...
    <%
      ...
      // Gerar a Tabela para Visualizar os Fornecedores Cadastrados

      CtrlFornecedor ctrl = new CtrlFornecedor();
      Vector <Fornecedor> lista = ctrl.buscarTodos();
      ...
      try
      {
         ...
         out.print("<font size=\"2\"    color=\"#FFFFFF\"   >Cnpj</font></td>");
         out.print("<td   width=\"8%\"  bgcolor=\"#999966\" align=\"center\">");
         out.print("<font size=\"2\"    color=\"#FFFFFF\"   >Contato</font></td>");
         ...
         if (lista.size() > 0)
         {
            ...
            for(int i = 0; i < lista.size(); i++)
            {
               ...
               out.print(registro.getCnpj());
               out.print("</font></td>");
               out.print("<td width=\"10%\" bgcolor=\"#FFFFFF\" align=\"center\" height=\"28\"><font size=\"2\">");
               out.print(registro.getContato());
               out.print("</font></td>");
               out.print("<td width=\"10%\" bgcolor=\"#FFFFFF\" align=\"center\" height=\"28\"><font size=\"2\">");
               ...
               out.print("<a href=\"fornecedoresProcessa.jsp?acao=exclui&id=" + registro.getIdFornecedor() + "\">" +
                         "<img border=\"0\" src=\"images/excluir.jpg\" width=\"23\" height=\"24\"></a></td>");
               out.print("<td width=\"3%\" bgcolor=\"#FFFFFF\" align=\"center\">");
               out.print("<a href=\"fornecedoresManutencao.jsp?operacao=alterar&id=" + registro.getIdFornecedor() + "\">" +
  ...
  <tr>
    ...
    <p align="center">&nbsp;<b><a href="fornecedoresManutencao.jsp?operacao=incluir">Cadastrar</a></b></td>
