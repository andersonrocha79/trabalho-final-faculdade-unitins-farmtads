<script language="JavaScript" type="text/javascript">
      ...
      function validaForm()
      {
         ...
         if (d.txtNome.value == "")
         {
            alert("O Nome do Fornecedor deve ser informado");
            d.txtNome.focus();
            return false;
         }
         ...
         if (d.txtEmail.value == "")
         {
            alert("O e-mail do Fornecedor deve ser informado");
            d.txtEmail.focus();
            return false;
         }
...
<%@page contentType="text/html"
        pageEncoding="UTF-8"
        language="java"
        import="com.farmacia.controle.CtrlFornecedor, com.farmacia.model.Fornecedor, com.Util.Util" %>
<html>
...
<body>
       ...
       <%
         ...
         if (funcao.equals("alterar"))
         {
            ...
            if ((!id.isEmpty()) && (Util.textoTemSoNumeros(id)))
            {
               ...
               Fornecedor registro = ctrlFornecedor.buscar(Integer.parseInt(id));

               if (registro.getIdFornecedor() > 0)
               {
                  codigo = Integer.toString(registro.getIdFornecedor());
                  if (registro.getNome()         !="") nome          = registro.getNome();
                  if (registro.getRazaoSocial()  !="") razaoSocial   = registro.getRazaoSocial();
                  if (registro.getTelefone()     !="") telefone      = registro.getTelefone();
                  if (registro.getEmail()        !="") email         = registro.getEmail();
                  if (registro.getCnpj()         !="") cnpj          = registro.getCnpj();
                  if (registro.getContato()      !="") contato       = registro.getContato();
  ...
  <form name="cadastro" method="POST" action="fornecedoresProcessa.jsp?acao=grava" onsubmit="return validaForm()" >
  ...
  <tr>
    ...
    <td width="159" height="30" align="left">
    <p align="right"><font color="#FFFFCC">Raz�o Social:</font></td>

    <td width="24" height="30" align="left">
    &nbsp;</td>

    <td width="614" height="30" colspan="4" align="left">
    <input type="text" name="txtRazaoSocial" size="69"<% if (razaoSocial=="") out.print("value=${param.txtRazaoSocial}"); else out.print("value=" + razaoSocial); %> maxlength="45"></td>
  ...
  <tr>
    ...
    <td width="159" height="30" align="left">
    <p align="right"><font color="#FFFFCC">CNPJ:</font></td>

    <td width="24" height="30" align="left">
    &nbsp;</td>

    <td width="614" height="30" colspan="4" align="left">
    <input type="text" name="txtCnpj" size="26" <% if (cnpj=="") out.print("value=${param.txtCnpj}"); else out.print("value=" + cnpj); %> maxlength="20"></td>

  </tr>
  <tr>

    <td width="159" height="30" align="left">
    <p align="right"><font color="#FFFFCC">Contato:</font></td>

    <td width="24" height="30" align="left">
    &nbsp;</td>

    <td width="614" height="30" colspan="4" align="left">
    <input type="text" name="txtContato" size="26" <% if (contato=="") out.print("value=${param.txtContato}"); else out.print("value=" + contato); %> maxlength="45"></td>
  ...
  <tr>
    ...
    <p align="center">
    <a href="fornecedores.jsp"><img border="0" src="images/botaoCancelar.JPG" width="210" height="29"></a></td>
