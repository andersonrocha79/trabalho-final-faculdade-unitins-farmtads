<%@page contentType="text/html"
        pageEncoding="UTF-8"
        language="java"
        import="com.farmacia.controle.CtrlCliente, com.farmacia.model.Cliente, java.util.Vector" %>
<html>
...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="66%" id="AutoNumber1" bgcolor="#666633" height="483">
  ...
  <tr>
    ...
    <%
      ...
      // Gerar a Tabela para Visualizar os Clientes Cadastrados

      CtrlCliente ctrl = new CtrlCliente();
      Vector <Cliente> lista = ctrl.buscarTodos();
      ...
      try
      {
         ...
         out.print("<font size=\"2\"    color=\"#FFFFFF\"   >Pontos</font></td>");
         ...
         if (lista.size() > 0)
         {
            ...
            for(int i = 0; i < lista.size(); i++)
            {
               ...
               out.print("<a href=\"clientesProcessa.jsp?acao=exclui&id=" + registro.getIdCliente() + "\">" +
                         "<img border=\"0\" src=\"images/excluir.jpg\" width=\"23\" height=\"24\"></a></td>");
               out.print("<td width=\"3%\" bgcolor=\"#FFFFFF\" align=\"center\">");
               out.print("<a href=\"clientesManutencao.jsp?operacao=alterar&id=" + registro.getIdCliente() + "\">" +
  ...
  <tr>
    ...
    <p align="center">&nbsp;<b><a href="clientesManutencao.jsp?operacao=incluir">Cadastrar</a></b></td>
